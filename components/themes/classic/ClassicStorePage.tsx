      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl lg:text-6xl font-serif text-amber-900 mb-6 leading-tight">
            ...
            <p className="text-lg lg:text-xl text-amber-800 font-serif leading-relaxed mb-8 italic">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {filteredProducts.map((product) => (
            <ClassicProductCard key={product.id} product={product} storeSlug={store.slug} />
          ))}
        </div>
