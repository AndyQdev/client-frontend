...
export default function LocationPicker({
  ...
  useEffect(() => {
    if (isMapLoaded && mapRef.current && !mapInstanceRef.current) {
      ...
      // NO actualizar coordenadas automáticamente
      // Solo centrar el mapa en la ubicación del usuario si está disponible
      // pero NO llamar a onLocationChange automáticamente
        ...
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(
            (position) => {
              ...
              // NO llamar a onLocationChange automáticamente
              // El usuario debe interactuar con el mapa para establecer la ubicación
            },
            () => {
  ...
  }, [isMapLoaded, onAddressChange, onLocationChange])
